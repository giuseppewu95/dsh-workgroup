...
export type WorkgroupMessageStatus = 'accepted' | 'queued' | 'started' | 'turn_completed' | 'failed';
 ...
 */
export declare function foldStatus(current: WorkgroupMessageStatus | undefined, observed: WorkgroupMessageStatus): WorkgroupMessageStatus | null;
