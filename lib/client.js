...
function memberStatus(member, t) {
  if (member.summary === void 0) return { state: "done", label: t("member.inactive") };
  return member.summary.running ? { state: "ongoing", label: t("member.running") } : { state: "done", label: t("member.inactive") };
}
            ...
            return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
              "button",
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "dsh-wg-member-status", children: status.label })
                ]
              },
              member.sessionId
            );
